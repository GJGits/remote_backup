...
void GetChunkDTO::link_content_buffer(std::shared_ptr<std::array<char, CHUNK_SIZE>> &buff) {this->rep_content = buff;}
std::shared_ptr<std::array<char, CHUNK_SIZE>> GetChunkDTO::get_content_buffer() const {return this->rep_content;}
