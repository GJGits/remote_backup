...
public:
    ...
    ChunkEntity(std::string username, int id_chunk, std::string path_file,  std::string last_mod):
            username{std::move(username)}, id_chunk{id_chunk}, path_file{std::move(path_file)}, last_mod{std::move(last_mod)}{};
